...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <p>Authors that write Mystery</p>
      <ul>
        <li v-for="author in mysteryWriters" :key="author.id">
          {{ author.name }}
        </li>
      </ul>
    </section>
...
// Helper function for specific writers
const mysteryWriters = computed(() => authors.filter((author) => author.genres.includes('Mystery')))

// Activity 3: Get all famous works
// const allFamousWorks = computed(() => {
//   // TODO: CODE TO GET ALL FAMOUS WORKS HERE
// })
// computed value: list of all famous works will change when authors change
// for every author, get in their famous works list and then get the ttitle of each work
const allFamousWorks = computed(() =>
